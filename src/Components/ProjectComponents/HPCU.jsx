    ...
    <div>
      <div className='row' style={{borderBottom:"2px solid red"}}>
        <div>
          ...
          <h2 className="text-center text-light pb-4">HPCU Process</h2>
          <p style={{fontSize:"23px", fontWeight:"700"}} className='text-center text-light'>High Pressuce Center Unit</p>
      ...
      <div className='row' style={{borderBottom:"2px solid red"}}>
        <div>
          <div className='pt-5 px-4'>
          <p style={{fontSize:"23px", fontWeight:"700"}} className='text-center text-light'>GAS TRAIN FOR GAS ENGINE</p>
          <p style={{fontSize:"23px", fontWeight:"700"}} className='text-center text-light'>MANDALAY POWER STATION</p>
          </div>
          <div className='row m-5'>
            <div className="col-md-6">
              <img src='http://techsepengg.com/proj-new-2.jpg' style={{width:"100%",height:"300px"}} alt='yes' />
            </div>
            <div className="col-md-6 p-3" style={{backgroundColor:"white"}}>
              <table>
                <tr>
                  <td>
                    ...
                    <p>Pr I/L; 400 Psig,</p>
                    <p>Pr O/L; 70 Psig</p>
                    <p>Design Pressure: 650 Psig</p>
                    <p>Flow: 40MMSCFD</p>
                    <p>Temp: 70 – 100 deg F</p>
                    {/* <b>Safety Device; 40 / 4MMSCFD</b>
                    <p>4”, 300 # SSV – 2nos</p>
                    <p>6”, 300 # SSV – 1no</p>
                    <p>1.5” x 2” ” CRV – 2nos</p>
